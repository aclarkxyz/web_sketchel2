...
var MainWindow = (function () {
    ...
    MainWindow.prototype.onResize = function () {
...
var DrawWindow = (function (_super) {
    ...
    function DrawWindow(root) {
        _super.call(this, root);
    }
    return DrawWindow;
}(MainWindow));
function runSketchEl(root) {
    var mol = Molecule.fromString('SketchEl!(10,10)\n' +
    ...
    var mw = new MainWindow(root);
    var table = $('<table class="data"></table>').appendTo(root);
    var tr = $('<tr></tr>').appendTo(table);
    var td = $('<td class="data"></td>').appendTo(tr);
